                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('production.index') }}">
                                        Producción
                                    </a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('movement.index') }}">
                                        Stock
                                    </a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('measurement.index') }}">
                                        Unidades de Medida
                                    </a>
                                    <a class="dropdown-item" href="{{ route('ingredient.index') }}">
                                        Ingredientes
                                    </a>
                                    <a class="dropdown-item" href="{{ route('recipe.index') }}">
                                        Recetas
                                    </a>
